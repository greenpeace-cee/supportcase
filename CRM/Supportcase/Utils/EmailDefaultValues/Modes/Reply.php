...
class CRM_Supportcase_Utils_EmailDefaultValues_Modes_Reply extends CRM_Supportcase_Utils_EmailDefaultValues_Modes_Base {
  ...
  public function getValues() {
    ...
    $prefillEmails = $this->getReplyPrefillEmails($emailsData['cc'], $emailsData['to'], $emailsData['from'], $mainEmailId);
