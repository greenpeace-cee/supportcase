...
/**
 * TODO: this is just a placeholder/demo - reimplement in AngularJS and delete me!
 */
class CRM_Supportcase_Form_Supportcase extends CRM_Core_Form {
  ...
  public function preProcess() {
    ...
    CRM_Utils_System::setTitle($caseType . ' #' . $this->_caseID);
